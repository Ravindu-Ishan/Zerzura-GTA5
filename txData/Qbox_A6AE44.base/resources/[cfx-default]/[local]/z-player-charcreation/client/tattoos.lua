-- Copied from illenium-appearance/shared/tattoos.lua (869 entries as of 2026-09-15).
-- No cross-resource export exists to read this catalog (only setPedTattoos to APPLY it),
-- so this is a static, read-only copy. Re-sync manually if illenium-appearance ever
-- updates its tattoo pack - this could drift out of sync with what it actually supports.
